...
<div class="container">
    <div class="content" id="content_news">
        <a class="list-group">
            ...
            <a href="/user/news?news_id=<%=news.getId()%>"
            ...
            <div class="news-footer">
                <button id="previousPage" class="button">Trang trước</button>
...
<script>
    $("#previousPage").click(function () {
        ...
        window.location.href = "/user/news_list?offset=" + offset + "&limit=" + limit;
    });
