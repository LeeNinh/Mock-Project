...
<html>
    <head>
        ...
        <title>ĐÁNH GIÁ SẢN PHẨM - Hutech SHOP</title>
...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
    ...
    <body>
         <%
            ...
            ProductEntity productEntity = new ProductRepo().getProduct(Long.parseLong(request.getParameter("product_id")));
        %>
        <jsp:include page="header.jsp"></jsp:include>
         <div class="banner-top">
	<div class="container">
		<h2 class="animated wow fadeInLeft" data-wow-delay=".5s">ĐÁNH GIÁ SẢN PHẨM</h2>
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="">Trang Chủ</a><label>/</label>Đánh giá sản phẩm</h3>
		...
		<div class="container">
                    <div class="col-md-8 contact-grids1 animated wow fadeInRight" data-wow-delay=".5s">
                        <form action="ReviewServlet" method="post">
                                    <input type="hidden" name="product_id" value="<%=productEntity.getProductID()%>">
